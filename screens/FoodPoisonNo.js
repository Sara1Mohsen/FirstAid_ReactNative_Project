...
export default class FoodPoisonNo extends React.Component {
        ...
        <View style={{ backgroundColor: "#fff", flex: 1 }}>
          ...
          <View style={{
            ...
            <View ref={this.callref} style={{
              ...
              <Text style={{fontSize:20}}>هل سبب التسمم بلع قرص غلة؟</Text>
              <View style={{width:"100%",flexDirection:"row",marginTop:"3%",justifyContent:"space-around"}}>
                <TouchableOpacity onPress={() => this.props.navigation.navigate("Home")} style={{width:80,height:40,backgroundColor:"white",borderRadius:5,alignItems:"center",justifyContent:"center"}}>
                  <Text style={{color:'#159da9',fontSize:18}}>لا</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.props.navigation.navigate("WheatPoison")} style={{width:80,height:40,backgroundColor:"white",borderRadius:5,alignItems:"center",justifyContent:"center"}}>
