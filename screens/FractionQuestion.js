...
export default class FractionQuestion extends React.Component {
             ...
             <SpeakerComponent Custom_ref={this.callref}  styles={{ color: '#fff',alignSelf:"flex-start",paddingHorizontal:"5%" }} />
              ...
              <View style={{width:"100%",flexDirection:"row",marginTop:"3%",justifyContent:"space-around"}}>
               ...
               <TouchableOpacity onPress={()=> this.props.navigation.navigate("Foot")} style={{width:"25%",alignItems:'center',justifyContent:'center'}}>
                <Image source={require("../images/leg.png")} style={{ height: 70, width:70}}/>
               </TouchableOpacity>

               <TouchableOpacity onPress={()=> this.props.navigation.navigate("FingerFraction")} style={{width:"25%",alignItems:'center',justifyContent:'center'}}>
                <Image source={require("../images/hand.png")} style={{ height: 70, width:70}}/>
               </TouchableOpacity>

               <TouchableOpacity onPress={()=> this.props.navigation.navigate("Vertebral")} style={{width:"25%",alignItems:'center',justifyContent:'center'}}>
                <Image source={require("../images/back.png")} style={{ height: 70, width:70}}/>
               </TouchableOpacity>
