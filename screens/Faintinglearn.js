        ...
        <View style={{ backgroundColor: "#fff", flex: 1 }}>
          ...
          <View style={{
            ...
            <ScrollView>
              ...
              <Image source={require("./images/image_3.png")} style={{ height: 130, width: 230, alignSelf: "center" , opacity: .8}} />
              <Text style={{ marginTop: '15%', fontSize: 12, marginRight: 20, color: '#159da9' }}>https://www.youtube.com/watch?v=EBZONfy43do </Text>
              <Text style={styles.text}>.فحص مجرى الهواء</Text>
              <Text style={styles.text}>.فحص مجرى التنفس</Text>
              <Image source={require("./images/image_2.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />

              <Text style={styles.titel}> طريقه فحص العلامات الحيوية للاطفال :-</Text>
              <Text style={styles.text}>.فحص النبض من الشريان العضدي</Text>
              <Image source={require("./images/image_1.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              <Text style={styles.text}>.فحص مجرى الهواء</Text>
              <Text style={styles.text}>.فحص مجرى التنفس</Text>
              <Image source={require("./images/Rectangle_43.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              <Text style={{ marginTop: '15%', fontSize: 12, marginRight: 20, color: '#159da9' }}>https://www.youtube.com/watch?v=IDMQZ4Ap9xo</Text>
              ...
              <Image source={require("./images/Rectangle_33.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              ...
              <Image source={require("./images/Rectangle_42.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              <Text style={styles.text}>.قم بالتنفس الصناعي للمريض مرتين في مده لا تتجاوز 10ثواني بعد كل 30 ضغطه</Text>
              <Image source={require("./images/Rectangle_48.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              <Text style={styles.text}>.لا تتوقف  حتي يستجيب المريض  </Text>
              <Text style={styles.text}>.او حتي وصول المسعفين  </Text>
              <Text style={{ marginTop: '15%', fontSize: 12, marginRight: 20, color: '#159da9' }}>https://www.youtube.com/watch?v=BvdwbjPQqpk</Text>
              ...
              <Image source={require("./images/Rectangle_40.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              ...
              <Image source={require("./images/Rectangle_45.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              ...
              <Image source={require("./images/Rectangle_47.png")} style={{ height: 130, width: 230, alignSelf: "center", opacity: .8 }} />
              <Text style={styles.text}>.لا تتوقف  حتي يستجيب المريض  </Text>
              <Text style={styles.text}>.او حتي وصول المسعفين  </Text>
              <Text style={{ marginTop: '15%', fontSize: 12, marginRight: 20, color: '#159da9' }}>https://www.youtube.com/watch?v=zNdF6iaPdI8 </Text>
